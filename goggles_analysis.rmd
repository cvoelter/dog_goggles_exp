...
#  filter(!Subject %in% c("Jolie",	"Jaimie",	"Leaf"))%>%  #LL: It seems this can be removed... There are no dogs with these names in the csv counterbalancing file
...
### MP: Plot of inspection behind barrier (did myself)
```{r}
...
### combine multiple plots into one #LL: should come below? After analysis and plot of looking time to opaque?
```{r}
...
```{r}
#LL:check what duration.data2 is about
